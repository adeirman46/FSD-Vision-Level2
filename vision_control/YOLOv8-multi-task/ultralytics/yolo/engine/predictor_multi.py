...
class BasePredictor:
    ...
    def write_results(self, idx, results_list, batch):
        ...
        for i,results in enumerate(results_list):
            if isinstance(results,list):
                ...
                if self.args.save or self.args.show:  # Add bbox to image
                    ...
                    print('Retina mask: ', self.args.retina_masks)
        ...
        if self.args.save_txt:
            ...
            print('Path predicted: ', self.txt_path)
        ...
        for batch in self.dataset:
            ...
            with profilers[2]:
                if self.args.task == 'multi':
                    print('entered multi task', type(preds))
                    self.results = []
    ...
    def save_preds(self, vid_cap, idx, save_path):
        ...
        print('im0_list: ', im0_list)
        print('len im0_list: ', len(im0_list))
